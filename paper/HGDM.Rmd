...
basin_schematic_cap <- "Schematic diagram of HGDM basin. Gray regions within the basin are dominated by
small depressions, white regions have no small depressions."
...
Because b \< 1, the catchments of large depressions have smaller ratios
to the areas of their depressions than those of small depressions.
...
When the PCM was incorporated in CRHM, the use of several HRUs (46) for
depressional storage reduced the importance of the inability to model
the water area of each HRU. The large number of small depressional HRUs in the 
modelsmeant that the water area increased with the addition of water, and decreased
with the removal of water, as the HRUs were partially-filled and fully
emptied, respectively.

@shookMemoryEffectsDepressional2011
...
the small ponds are filled first, so the median water area filling curve
will come to resemble that of the large depressions. When the
depressions are emptied, the ponds in small depressions are
progressively eliminated. Thus the emptying curve lies below even the
...
possible to implement the calculation of the water area as described
above.
